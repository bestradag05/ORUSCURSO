...
namespace ORUSCURSO.Presentacion
{
    public partial class Personal : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            PanelRegistros.Dock = DockStyle.Fill;//expandir todo el panel
        ...
        private void LocalizarDtvCargos()
        {
            ...
            datalistadoCargos.Size = new Size(465, 141);
        ...
        private void Insertar_Cargos()
        {
            ...
            if(!string.IsNullOrEmpty(txtCargoG.Text))
            {
                if(!string.IsNullOrEmpty(txtsueldoG.Text)) {
                    ...
                    if (funcion.InsertarCargos(parametros) == true)
                    {
                        txtCargo.Clear();
                        BuscarCargos();
                        PanelCargos.Visible = false;    
        ...
        private void btnAgregarCargo_Click(object sender, EventArgs e)
        {
            ...
            PanelCargos.BringToFront();//traer al frente el panel
        ...
        private void btnGuardarCambiosC_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void txtsueldoG_TextChanged(object sender, EventArgs e)
        {
        ...
        private void editarCargos()
        {
            ...
            parametros.Cargo = txtCargoG.Text;
            parametros.SueldoPorHora = Convert.ToDouble(txtSueldoHora.Text);
            if (funcion.editarCargos(parametros) == true)
            {
                txtCargo.Clear();
                BuscarCargos();
                PanelCargos.Visible = false;
        ...
        {
            DialogResult result = MessageBox.Show("Este personal se elimino. ¿Desea volver a  Habilitarlo?", "Restauracion de registro", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
            if(result == DialogResult.OK) {
        ...
        private void EditarPersonal()
        {
            ...
            if(funciones.editarPersonal(parametros)== true ) 
            {
                MostrarPersonal();
                PanelRegistros.Visible = false;
